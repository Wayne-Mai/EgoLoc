...
if __name__ == '__main__':
    ...
    my_mp_align_txt= os.path.join('data/mp_register', my_uid, 'geo.txt')
    my_twostage_img_txt=os.path.join('data/kw60746_vq2d/register', my_uid, 'image_list.txt')
